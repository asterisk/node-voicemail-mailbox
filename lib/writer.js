    ...
    states: {
      ...
      'init': {
        _onEnter: function() {
          ...
          ari.getClient(ariConfig.url, ariConfig.username,
                        ariConfig.password, ariConfig.applicationName)
      ...
      'ready' : {
        record: function() {
          ...
          var intro = dependencies
            ...
            .mailboxWriter
            .intro;
          this.introPrompt =  dependencies.prompt.create(intro);
      ...
      'recording': {
        _onEnter: function() {
          ...
          var record = Q.denodeify(this.client.record.bind(this.client));
